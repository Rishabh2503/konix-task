...
function Tokenomics() {
  return (
    <div className="bg-white h-max rounded-lg my-5 p-4 md:p-6">
      <div className="text-[#0F1629] text-xl md:text-2xl font-semibold">Tokenomics</div>
      <div className="my-4">
        <div className="text-[#1D1D1D] text-lg md:text-xl font-semibold">
        ...
        <div className="py-4 flex flex-col md:flex-row">
          ...
          <div className="flex flex-col justify-center ml-0 md:ml-8">
            <div className="flex items-center">
              ...
              <div className="text-[#202020] text-base md:text-lg font-normal ml-4">
        ...
        <div className="text-[#3E424A] text-sm md:text-[16px] py-2">
